...
const QUESTIONS = [
  {
    "id": "q1",
    "dim": "S1",
    "text": "我承认，我就是个loser。成绩吊车尾，没谈过恋爱，连暗恋都不敢，因为照照镜子就知道不配。每次查成绩看到的是垫底的排名，每天早上五点半起床，晚上九点半点还在刷题，分数却纹丝不动。看着班里那些又好看又聪明的人，觉得我们活在不同的世界。我就是下水道里的老鼠，透过排水口看别人阳光下的青春。求求了，给我们这种小透明高中生一点活路吧。我真的不想在凌晨一点，对着做不出来的数学题，把枕头哭湿一片。",
    "options": [
      {
        "label": "我哭了😭。。",
        "value": 1
  ...
  },
  {
    "id": "q7",
    "dim": "E1",
    "text": "有人在别人面前提起你，并且你一来就转移话题，你更倾向于？",
    "options": [
      {
        "label": "TA肯定是在蛐蛐我😡",
        "value": 1
  ...
  },
  {
    "id": "q15",
    "dim": "A2",
    "text": "快考试了，你必须要认真复习，但今晚你的朋友邀请你一起打《王者荣耀》（一款5V5多人公平竞技对抗手游，胜率为50%），你会？",
    "options": [
      {
        "label": "通宵！反正就一次！",
        "value": 1
  ...
  },
  {
    "id": "q18",
    "dim": "A3",
    "text": "突然某一天，我意识到人生哪有什么他妈的狗屁意义，某个晚上躺在床上，你突然开始思考：人活着到底为了啥？上学、考试、打工、还贷、退休、等死？这不就是一个超长待机的流水线吗？跟实验室里跑滚轮的仓鼠有啥区别？",
    "options": [
      {
        "label": "是这样的。",
        "value": 1
  ...
  },
  {
    "id": "q25",
    "dim": "So1",
    "text": "你因被别人知道自己玩二游，经常被别人称呼为旅行者、漂泊者、开拓者、无名客，",
    "options": [
      {
        "label": "网上玩玩就算了，线下也太尴尬了",
        "value": 1
      },
      {
        "label": "叫对名了",
...
const TYPE_IMAGES = {
  ...
  "WOC!": "assets/images/WOC.png",
  "DRUNK": "assets/images/DRUNK.png",
  "IMFW": "assets/images/IMFW.png"
};
